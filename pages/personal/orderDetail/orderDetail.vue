<template>
	<view style="background-color: #f3f4f6;">
			...
			<view class="order">
				...
				<view class="item">
					...
					<view class="content">
						...
						<!--startTime--><view class="delivery-time">租赁开始时间 {{ order.startTime }}</view>
		...
		<!-- <view style="position: absolute; bottom: 0px; width: 100%; height: 60px; line-height: 60px; border:1px solid #E9E9E9; ">
			<a-button class="order-btn" @click="pay()">付款</a-button>
		</view> -->
