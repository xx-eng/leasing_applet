<template>
	<view style="background-color: #f3f4f6;">
			...
			<view class="order">
				...
				<view class="item">
					...
					<view class="right">
						...
						<view class="number">x{{ goodsDetial.price }}</view>
					</view>
				</view>
				<view class="total">
					合计:
		...
		<u-button @click="showPop(true)" style="color: white; background-color: #339966; position: absolute; bottom: 0px; width: 100%;">购买</u-button>
