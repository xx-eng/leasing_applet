	...
	<view>
		<u-form :model="model" :rules="rules" ref="uForm" :errorType="errorType">
			<u-form-item :leftIconStyle="{color: '#888', fontSize: '32rpx'}" label-width="120" :label-position="labelPosition"
			 label="名称" prop="title">
				<u-input :border="border" placeholder="请输入名称" v-model="model.title" type="text"></u-input>
			</u-form-item>
			...
			<u-form-item :label-position="labelPosition" label="简介" prop="abstract">
				<u-input type="textarea" :border="border" placeholder="请填写简介" v-model="model.abstract" />
			</u-form-item>
			<u-form-item :label-position="labelPosition" label="押金" prop="deposit">
				<u-input :border="border" type="number" v-model="model.deposit" placeholder="请输入押金"></u-input>
			</u-form-item>
			<u-form-item :label-position="labelPosition" label="租金" label-width="150" prop="rental">
				<u-input :border="border" type="number" v-model="model.rental" placeholder="请确认租金"></u-input>
			</u-form-item>
		...
		<school-tab-bar :currentTab="4" style="position: fixed; bottom: 0px; padding: 0; margin: 0; z-index: 100;"></school-tab-bar>
	</view>
</template>
