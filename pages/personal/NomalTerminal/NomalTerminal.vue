<template>
	<view style="background-color: #f3f4f6;">
		...
		<view class="uni-input-wrapper">
			<input class="uni-input" v-model="logisticsId" focus placeholder="请输入退款物流单号" />
		</view>

		<u-button @click="normalTerminalOrder" style="color: white; background-color: #339966; position: absolute; bottom: 0px; width: 100%;">退款</u-button>
...
<script>
	...
	export default {
		...
		methods: {
			...
			normalTerminalOrder() {
				normalTerminalOrder(this.order.id, this.logisticsId).then(res => {
